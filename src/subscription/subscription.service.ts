...
export class SubscriptionService {
   constructor(
    ...
    async subscribe(createSubDto: CreateSubscriptionDto): Promise<SubscriptionTokenDto>{
        ...
        try {
            ...
            if(api && profile){            
                ...
                const subToken : SubscriptionTokenDto = {subscriptionToken:newSub.subscriptionToken}
