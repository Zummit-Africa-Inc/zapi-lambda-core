...
export class logger1664959941786 implements MigrationInterface {
  name = 'logger1664959941786';
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."logger_action_type_enum" AS ENUM('update', 'delete')`,
    );
    await queryRunner.query(
